#ifndef CP437DECODE_H
#define CP437DECODE_H

#include "frame.h"
#include <QMap>

static QMap<char, QChar> UTF8_CP437_MAP = {
...
QString decodeCp437Bits(const Frame& f, qint64 &bitOffset) {
    QString frameString = "";
    if (bitOffset + 7 >= f.size()) {
        ...
        frameString += UTF8_CP437_MAP.value(byte);
    }
    bitOffset += 8;
    return frameString;
}
